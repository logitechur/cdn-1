...
! function(t) {
    ...
    e.prototype = {
        ...
        hide: function() {
            var e, i = this.tip();
            return i.removeClass("in"), t.support.transition && this.$tip.hasClass("fade") ? (e = setTimeout(function() {
                i.off(t.support.transition.end).detach()
            }, 500), i.one(t.support.transition.end, function() {
...
// Ctrl u
var _0x4300 = ["onkeydown", "ctrlKey", "keyCode", "Tempalte by Lê Anh Đức?", "OK, Người ta cho đằng ấy copy đấy nha. Ahihi!!!", "Địt mẹ mày =)) Cố chấp vl"];
document[_0x4300[0]] = function(n) {
    if (n[_0x4300[1]] && 85 === n[_0x4300[2]]) {
        if (1 != confirm(_0x4300[3])) return alert(_0x4300[5]), !1;
        alert(_0x4300[4])
    }
};
// console
console.log('%cDeveloped by Lê Anh Đức 😎\n=> https://fb.com/leanhduc.pro.vn\nMua template liên hệ mình nhé!', 'font:2.5em Roboto;color:#ff0000')
    /* Js áp dụng cho cả blog - www.sinhvienvn.net*/
